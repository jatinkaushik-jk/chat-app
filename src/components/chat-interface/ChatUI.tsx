...
const ChatUI = ({groupName, userName}:{groupName: string | null, userName: string | null}) => {
  ...
  return (
    ...
    <div className="h-screen w-full flex flex-col rounded-xl overflow-hidden shadow-lg bg-[#e5ddd5] font-sans">
      ...
      >
        ...
        {isTyping && (
          <div className="text-sm text-gray-500 p-1">{userName} is typing…</div>
        )}
        {
          isNewUserJoined && <div className="text-sm text-gray-500 p-1">{newUserName} has joined the chat.</div>
        }
      </div>
